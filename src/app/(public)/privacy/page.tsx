...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-background text-foreground transition-colors duration-500 font-sans text-gray-900 dark:text-foreground flex flex-col">
      <nav className="fixed top-0 w-full z-50 bg-transparent border-b border-gray-200 dark:border-border transition-colors">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 pt-40 pb-24">
        ...
        <p className="text-sm font-mono text-[#75fbd9] tracking-widest uppercase mb-12">Last Updated: October 2026</p>
        ...
        <div className="space-y-12 text-gray-600 dark:text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 dark:text-foreground mb-4">3. Tracking & Cookies</h2>
      ...
      <footer className="w-full border-t border-gray-200 dark:border-border bg-gray-50 dark:bg-[#030303] py-16 px-6 transition-colors duration-500">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-10 text-[10px] text-gray-500 dark:text-gray-600 font-mono tracking-[0.2em] uppercase transition-colors">
            ...
            <Link href="/#features" className="hover:text-gray-900 dark:hover:text-foreground transition-colors">Features</Link>
            <Link href="/privacy" className="hover:text-gray-900 dark:hover:text-foreground transition-colors">Privacy</Link>
          </div>
        </div>
      </footer>
    </div>

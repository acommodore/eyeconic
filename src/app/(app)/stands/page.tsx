...
export default function StandsPage() {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto min-h-screen text-foreground bg-background">
      ...
      <div className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border px-4 md:px-8 py-4">
        <div className="flex gap-3 overflow-x-auto pb-2 hover-scrollbar hide-scrollbar-mobile">
          ...
          <button onClick={() => scrollToSection('scheduled')} className="px-6 py-2.5 rounded-full border border-border text-muted-foreground font-bold tracking-widest text-xs whitespace-nowrap hover:bg-card text-card-foreground/5 dark:bg-white/5 hover:text-foreground transition-all flex items-center gap-2 cursor-pointer">
            <Calendar className="w-4 h-4" /> SCHEDULED
          </button>
          <button onClick={() => scrollToSection('trending')} className="px-6 py-2.5 rounded-full border border-border text-muted-foreground font-bold tracking-widest text-xs whitespace-nowrap hover:bg-card text-card-foreground/5 dark:bg-white/5 hover:text-foreground transition-all flex items-center gap-2 cursor-pointer">
            <Activity className="w-4 h-4" /> TOP VOICES
          </button>
          <button onClick={() => scrollToSection('my-clubs')} className="px-6 py-2.5 rounded-full border border-border text-muted-foreground font-bold tracking-widest text-xs whitespace-nowrap hover:bg-card text-card-foreground/5 dark:bg-white/5 hover:text-foreground transition-all flex items-center gap-2 cursor-pointer">
            <Shield className="w-4 h-4" /> MY CLUBS
          </button>
          <button onClick={() => scrollToSection('highlights')} className="px-6 py-2.5 rounded-full border border-border text-muted-foreground font-bold tracking-widest text-xs whitespace-nowrap hover:bg-card text-card-foreground/5 dark:bg-white/5 hover:text-foreground transition-all flex items-center gap-2 cursor-pointer">
      ...
      <div className="p-4 md:p-8 space-y-16">
            ...
            <div className="relative z-20 p-6 md:p-12 flex flex-col md:flex-row items-end justify-between gap-8 h-full min-h-[400px]">
              ...
              <div className="max-w-2xl">
                <div className="flex items-center gap-3 mb-6">
                  <span className="px-3 py-1.5 rounded-md bg-red-600 text-[10px] font-black tracking-widest text-foreground flex items-center gap-2 shadow-[0_0_15px_rgba(220,38,38,0.5)]">
                    <span className="w-2 h-2 rounded-full bg-white animate-pulse" /> ON AIR
                  </span>
                  <span className="text-xs font-bold text-[teal] tracking-widest bg-[teal]/10 px-3 py-1.5 rounded-md border border-[teal]/20">
                    12.4K LISTENING
                  </span>
                </div>
                
                <h1 className="text-3xl md:text-5xl font-black text-foreground leading-tight mb-4 tracking-wide">
                  Arsenal vs Man City:<br/>Title Decider Post-Match
                </h1>
                <p className="text-muted-foreground font-medium md:text-lg line-clamp-2 max-w-xl mb-8">
              ...
              <div className="bg-card text-card-foreground/5 dark:bg-white/5 backdrop-blur-md border border-border rounded-2xl p-4 w-full md:w-auto min-w-[250px]">
                <h4 className="text-[10px] font-black text-muted-foreground/80 tracking-widest uppercase mb-4">On Stage</h4>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                     <div className="w-8 h-8 rounded-full bg-[teal] p-0.5"><img className="w-full h-full rounded-full bg-card text-card-foreground" src="https://api.dicebear.com/7.x/avataaars/svg?seed=Host1" /></div>
                     <div><p className="text-xs font-bold text-foreground">Gooner4Life</p><p className="text-[9px] text-[teal] font-bold">HOST</p></div>
                     <Mic className="w-3 h-3 text-[teal] ml-auto" />
                  </div>
                  <div className="flex items-center gap-3">
                     <div className="w-8 h-8 rounded-full bg-card text-card-foreground/10 dark:bg-white/10 p-0.5"><img className="w-full h-full rounded-full bg-card text-card-foreground" src="https://api.dicebear.com/7.x/avataaars/svg?seed=Host2" /></div>
                     <div><p className="text-xs font-bold text-gray-300">CityZenX</p><p className="text-[9px] text-muted-foreground/80 font-bold">CO-HOST</p></div>
                  </div>
                  <div className="flex items-center gap-3">
                     <div className="w-8 h-8 rounded-full bg-card text-card-foreground/10 dark:bg-white/10 p-0.5"><img className="w-full h-full rounded-full bg-card text-card-foreground" src="https://api.dicebear.com/7.x/avataaars/svg?seed=Host3" /></div>
                     <div><p className="text-xs font-bold text-gray-300">TacticsGuy</p><p className="text-[9px] text-muted-foreground/80 font-bold">SPEAKER</p></div>
                  </div>
                </div>
              </div>
          ...
          <section id="live-now" className="scroll-mt-32">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-black tracking-widest text-foreground flex items-center gap-3 uppercase">
                <Flame className="w-5 h-5 text-[coral]" />
                Live Stands
              </h2>
              <span className="text-xs text-muted-foreground font-bold hover:text-foreground cursor-pointer transition-colors uppercase tracking-widest">View All</span>
            </div>
                ...
                <div className="aspect-[4/3] md:aspect-[3/2] rounded-[24px] overflow-hidden relative group border border-border hover:border-[teal]/30 transition-all hover:shadow-[0_0_30px_rgba(117, 251, 217,0.15)] flex flex-col">
                  ...
                  <div className="relative z-20 p-5 flex flex-col h-full justify-between">
                    <div className="flex justify-between items-start">
                      <span className="px-2 py-1 rounded bg-red-600 text-[9px] font-black text-foreground flex items-center gap-1 uppercase tracking-widest">
                        <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" /> Live
                      </span>
                      <span className="px-2 py-1 rounded bg-card text-card-foreground/50 backdrop-blur text-[9px] font-bold text-foreground tracking-widest border border-border">
                        5.2K LISTENING
                      </span>
                    </div>

                    <div className="mt-auto">
                      <h3 className="text-lg font-black text-foreground leading-tight mb-2 group-hover:text-[teal] transition-colors line-clamp-2">
          ...
          <section id="scheduled" className="mb-12 scroll-mt-32">
             <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-black tracking-widest text-foreground uppercase flex items-center gap-3">
                <Clock className="w-5 h-5 text-[teal]" /> Scheduled Today
              </h2>
              <span className="text-[10px] text-muted-foreground font-bold hover:text-foreground cursor-pointer transition-colors uppercase tracking-widest">See all</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-bold text-foreground text-sm group-hover:text-[teal] transition-colors truncate">UCL Semi-final Preview</h4>
                  <p className="text-[10px] text-[teal] font-bold uppercase tracking-widest mt-1">In 2h 15m</p>
                </div>
                <button className="w-8 h-8 rounded-full bg-card text-card-foreground/5 dark:bg-white/5 flex items-center justify-center hover:bg-card text-card-foreground/10 dark:bg-white/10 transition-colors border border-border shrink-0">
              ...
              <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-bold text-foreground text-sm group-hover:text-[coral] transition-colors truncate">Transfer Deadline Talk</h4>
                  <p className="text-[10px] text-[coral] font-bold uppercase tracking-widest mt-1">In 3h 45m</p>
                </div>
                <button className="w-8 h-8 rounded-full bg-card text-card-foreground/5 dark:bg-white/5 flex items-center justify-center hover:bg-card text-card-foreground/10 dark:bg-white/10 transition-colors border border-border shrink-0">
                  <Bell className="w-3 h-3 text-foreground" />
                </button>
               ...
               <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-bold text-foreground text-sm group-hover:text-[#6200EA] transition-colors truncate">La Liga Title Race</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <section id="trending" className="scroll-mt-32">
               <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[10px] text-muted-foreground font-bold hover:text-foreground cursor-pointer transition-colors uppercase tracking-widest">Discover</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-foreground text-sm">Gooner4Life</h4>
                    <p className="text-[10px] text-muted-foreground/80 font-bold uppercase tracking-widest mt-1">12.4K Followers</p>
                  </div>
                ...
                <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-foreground text-sm">TacticsGuy</h4>
                    <p className="text-[10px] text-muted-foreground/80 font-bold uppercase tracking-widest mt-1">8.2K Followers</p>
                  </div>
                  <button className="px-4 py-1.5 rounded-full bg-white text-black text-xs font-black tracking-widest hover:bg-gray-200 transition-colors shrink-0">
                    FOLLOW
                  </button>
                ...
                <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-foreground text-sm">MadridistaHQ</h4>
                    <p className="text-[10px] text-muted-foreground/80 font-bold uppercase tracking-widest mt-1">5.9K Followers</p>
                  </div>
                  <button className="px-4 py-1.5 rounded-full border border-white/20 text-foreground text-xs font-black tracking-widest hover:bg-card text-card-foreground/10 dark:bg-white/10 transition-colors shrink-0">
                    FOLLOWING
                  </button>
                </div>
            ...
            <section id="my-clubs" className="scroll-mt-32">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-black tracking-widest text-foreground uppercase flex items-center gap-3">
                  <Shield className="w-5 h-5 text-muted-foreground" /> My Clubs
                </h2>
                <span className="text-[10px] text-muted-foreground font-bold hover:text-foreground cursor-pointer transition-colors uppercase tracking-widest">Manage</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-sm text-foreground">Liverpool FC</h4>
                    <p className="text-[10px] font-bold text-[teal] mt-1 flex items-center gap-1.5 uppercase tracking-widest">
                      <span className="w-1.5 h-1.5 rounded-full bg-[teal] animate-pulse" /> 2 LIVE ROOMS
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-sm text-foreground">Arsenal FC</h4>
                    <p className="text-[10px] font-bold text-[coral] mt-1 flex items-center gap-1.5 uppercase tracking-widest">
                      <span className="w-1.5 h-1.5 rounded-full bg-[coral] animate-pulse" /> 1 LIVE ROOM
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 bg-[#0A0A0A] border border-border p-4 rounded-2xl hover:bg-card text-card-foreground/5 dark:bg-white/5 transition-colors group cursor-pointer">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-sm text-foreground">Tottenham</h4>
          ...
          <section id="highlights" className="mt-12 scroll-mt-32">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-[10px] text-muted-foreground font-bold hover:text-foreground cursor-pointer transition-colors uppercase tracking-widest">Browse Clips</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-[#0A0A0A] border border-border rounded-[24px] overflow-hidden group cursor-pointer hover:border-white/20 transition-all hover:shadow-[0_0_30px_rgba(255,255,255,0.05)]">
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-20">
                    <div className="w-12 h-12 rounded-full bg-card text-card-foreground/50 backdrop-blur border border-white/20 flex items-center justify-center group-hover:bg-white/20 transition-colors">
                      <Play className="w-5 h-5 text-foreground ml-1" />
                    </div>
                  </div>
                  <span className="absolute bottom-3 right-3 z-20 px-2 py-1 rounded bg-card text-card-foreground/80 text-[10px] font-bold text-foreground tracking-widest border border-border flex items-center gap-1">
                    <Scissors className="w-3 h-3 text-yellow-500" /> 1:45
                  </span>
                </div>
                <div className="p-4">
                  <h4 className="font-bold text-foreground text-sm group-hover:text-gray-300 transition-colors line-clamp-2">"That was never a penalty!" - Heated El Clasico Debate</h4>
                  <p className="text-[10px] text-muted-foreground/80 font-bold mt-2 uppercase tracking-widest flex items-center gap-2">
              ...
              <div className="bg-[#0A0A0A] border border-border rounded-[24px] overflow-hidden group cursor-pointer hover:border-white/20 transition-all hover:shadow-[0_0_30px_rgba(255,255,255,0.05)]">
                ...
                <div className="p-4">
                  <h4 className="font-bold text-foreground text-sm group-hover:text-gray-300 transition-colors line-clamp-2">Roy Keane's brutal takedown of Man United midfield</h4>
                  <p className="text-[10px] text-muted-foreground/80 font-bold mt-2 uppercase tracking-widest flex items-center gap-2">
               ...
               <div className="bg-[#0A0A0A] border border-border rounded-[24px] overflow-hidden group cursor-pointer hover:border-white/20 transition-all hover:shadow-[0_0_30px_rgba(255,255,255,0.05)]">
                ...
                <div className="p-4">
                  <h4 className="font-bold text-foreground text-sm group-hover:text-gray-300 transition-colors line-clamp-2">"Messi wouldn't survive a cold night in Stoke"</h4>
                  <p className="text-[10px] text-muted-foreground/80 font-bold mt-2 uppercase tracking-widest flex items-center gap-2">
              ...
              <div className="bg-[#0A0A0A] border border-border rounded-[24px] overflow-hidden group cursor-pointer hover:border-white/20 transition-all hover:shadow-[0_0_30px_rgba(255,255,255,0.05)] hidden lg:block">
                ...
                <div className="p-4">
                  <h4 className="font-bold text-foreground text-sm group-hover:text-gray-300 transition-colors line-clamp-2">Why Bellingham is already better than Zidane</h4>
                  <p className="text-[10px] text-muted-foreground/80 font-bold mt-2 uppercase tracking-widest flex items-center gap-2">
                    <Calendar className="w-3 h-3" /> LAST WEEK
                  </p>
                </div>

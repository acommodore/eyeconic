...
export default function LeaderboardPage() {
  return (
    <div className="w-full h-[80vh] flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in duration-500">
      <div className="w-24 h-24 rounded-full bg-[#FF7F50]/10 flex items-center justify-center mb-6 border border-[#FF7F50]/30 shadow-[0_0_30px_rgba(255,79,0,0.2)]">
        <Trophy className="w-12 h-12 text-[#FF7F50]" />
      </div>

  ...
  return (
    <div className="bg-[#020202] min-h-screen">
      ...
      <div className="relative w-full rounded-none md:rounded-2xl overflow-hidden mb-4 border-b md:border border-border shadow-2xl">
        ...
        <div className="relative z-20 px-6 pb-12 pt-10 md:px-12 md:pb-12 md:pt-10 flex flex-col items-center justify-center">
      ...
      {activeTab === 'STATS' && (
        <motion.div 
          ...
          exit={{ opacity: 0, y: -15 }}
          transition={{ duration: 0.3 }}
          className="w-full max-w-4xl mx-auto relative group px-4"
        >

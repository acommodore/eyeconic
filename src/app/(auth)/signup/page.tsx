...
export default function SignupPage() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <h1 className="text-3xl font-bold mb-2">Lock it in</h1>
      <p className="text-gray-400 text-sm mb-8">Prove your football eye.</p>
      ...
      <form className="w-full space-y-4" onSubmit={handleSignup}>
        ...
        <button type="submit" className="w-full mt-8 bg-[#FF7F50] text-[#050505] font-bold text-sm tracking-wide py-4 rounded-xl hover:bg-[#FF7F50]/90 transition-all shadow-[0_0_20px_rgba(255,79,0,0.3)]">
          STEP IN
        </button>
      </form>

      <p className="mt-8 text-sm text-gray-400">
        Already have an account? <Link href="/login" className="text-[#00E5FF] hover:underline">Login</Link>
      </p>
    </div>
  );
}
